...
const Categoria = () => {
    return (
        <>
            ...
            <hr className='mt-5' />
            <div className='d-flex flex-columns flex-lg-row justify-content-center align-items-center gap-3  m-4 p-5 '>
                <div className="d-flex flex-column flex-xxl-row  gap-3 m-4 p-5 ">
                    <div>
                        <h2 className='text-center'>Restaurante</h2>
                        <CardGroup className='className="d-flex flex-column flex-md-row'>
                            <Card>
